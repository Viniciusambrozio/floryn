...
//       }
    ...
    _updatePrice: function(variant) {
      // Sempre dispara o evento de mudança de preço se currentVariant não estiver definido
      // ou se os preços forem diferentes
      if (
        this.currentVariant && 
...
theme.Product = (function() {
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _initVariants: function() {
      ...
      // Força a atualização do preço na inicialização
      var currentVariant = this.variants.currentVariant;
      if (currentVariant) {
        this._updatePrice({ variant: currentVariant });
      }
    },
...
//           .attr('aria-hidden', 'false');
    ...
    _updatePrice: function(evt) {
      var variant = evt.variant;
      console.log("Updating price for variant:", variant.id, "Price:", variant.price);
