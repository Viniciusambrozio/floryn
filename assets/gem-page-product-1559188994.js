        ...
        jQuery(function() {
            var $module = jQuery('#m-1559189004034').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1559189004034-0').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1559189004005').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1559189004034-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1559189004034-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1559189004035').children('.module');
            var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
        ...
        jQuery(function() {
            var $module = jQuery('#m-1559189004044').children('.module');
            var style = $module.attr('data-style');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1559189004034-3').children('.module');
            $module.gfV3ProductCartButton({ onItemAdded: function() {}});
        }); 
    
        jQuery(function() {
          var $module = jQuery('#m-1559189193532').children('.module');
        });
    
        jQuery(function() {
            var $module = jQuery('#m-1559189282426').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1559189313493').children('.module');
            $module.gfV3Product();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1559189329721').children('.module');
            var style = $module.attr('data-style');
            var updatePrice = $module.attr('data-updateprice');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1559189313493-0').children('.module');
            var effect = $module.attr('data-effect');
            $module.gfV3ProductImage({
                'effect': effect
            })
        ...
        jQuery(function() {
            var $module = jQuery('#m-1559189313493-1').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1559189313493-2').children('.module');
            $module.gfV3ProductPrice();
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1559189313493-3').children('.module');
            $module.gfV3ProductCartButton({ onItemAdded: function() {}});
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1559189290571').children('.module');
            $module.gfV1Instagram();
        });
    
        jQuery(function() {
            var $hero = jQuery('#m-1542787202168');
            var $module = jQuery('#m-1542787202168').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1559189360935').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1559189366832').children('.module');
            $module.gfV1Countdown({
                id: "1559189366832",
                idSlug: "1559189366832"
            });
        });
    
        jQuery(function() {
            var $hero = jQuery('#m-1542788125966');
            var $module = jQuery('#m-1542788125966').children('.module');
        ...
        jQuery(function() {
          var $module = jQuery('#m-1559189096906').children('.module');
        }); 
    
        jQuery(function() {
          var $module = jQuery('#m-1559189096902').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1559189106420').children('.module');   
            var navspeed = $module.data('navspeed'),
        ...
        jQuery(function() {
          var $module = jQuery('#m-1559189106500').children('.module');
        }); 
